...
gambar = fs.readFileSync('./media/image/braja.jpg')
...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: fs.readFileSync('./media/image/braja.jpg'), caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/naze_\n\n*Atau Transfer via*\n- *Gopay Dana Ke nomer berikut : 085846641118\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
